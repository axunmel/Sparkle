...
class PokemonDataSource {
  ...
  const PokemonDataSource(this.name, this.generationFolder);
}


const List<String> gen1 = [
  ...
  'seaking','staryu','starmie','mr_mime','scyther','jynx','electabuzz','magmar','pinsir',
...
const List<String> gen3 = [
  ...
  'banette', 'duskull', 'dusclull', 'tropius', 'chimecho', 'absol',
...
const List<String> gen4 = [
  ...
  'skuntank', 'bronzor', 'bronzong', 'bonsly', 'mime_jr', 'happiny', 
  ...
  'glaceon', 'gliscor', 'mamoswine', 'porygon_z', 'gallade', 'probopass', 
  'dusknoir', 'froslass', 'rotom', 'uxie', 'mesprit', 'azelf', 
  'dialga', 'palkia', 'heatran', 'regigigas', 'giratina', 'cresselia', 
  'phione', 'manaphy', 'darkrai', 'shaymin', 'arceus'
];

const List<String> gen5 = [
...
const List<String> gen7 = [
  ...
  'palossand', 'pyukumuku', 'codigo_cero', 'silvally', 'minior', 'komala',
  'turtonator', 'togedemaru', 'mimikyu', 'bruxish', 'drampa', 'dhelmise',
  'jangmo_o', 'hakamo_o', 'kommo_o', 'tapu_koko', 'tapu_lele', 'tapu_bulu',
  'tapu_fini', 'cosmog', 'cosmoem', 'solgaleo', 'lunala', 'nihilego',
...
const List<String> gen8 = [
  ...
  'cursola', 'sirfetchd', 'mr_rime', 'runerigus', 'milcery', 'alcremie',
...
const List<String> gen9 = [
  ...
  'dondozo','tatsugiri','annihilape','clodsire','farigiraf','dudunsparce','kingambit',
  ...
  'chien-pao', 'ting-lu', 'chi-yu','koraidon', 'miraidon','dipplin',
  'poltchageist', 'sinistcha','okidogi', 'munkidori', 'fezandipiti',
  'ogerpon','archaludon','hydrapple','gouging-fire',
  'pecharunt','raging-bolt','iron-boulder','iron-crown','terapagos','pecharunt'
];


final List<PokemonDataSource> allPokemonData = [
  ...gen1.map((name) => PokemonDataSource(name, 'gen1')),
  ...gen2.map((name) => PokemonDataSource(name, 'gen2')),
  ...gen3.map((name) => PokemonDataSource(name, 'gen3')),
  ...gen4.map((name) => PokemonDataSource(name, 'gen4')),
  ...gen5.map((name) => PokemonDataSource(name, 'gen5')),
  ...gen6.map((name) => PokemonDataSource(name, 'gen6')),
  ...gen7.map((name) => PokemonDataSource(name, 'gen7')),
  ...gen8.map((name) => PokemonDataSource(name, 'gen8')),
  ...gen9.map((name) => PokemonDataSource(name, 'gen9')),
];